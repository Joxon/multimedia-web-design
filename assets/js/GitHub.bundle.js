  ...
  return (function e(t, n, r) {
  ...
  })(
    {
          ...
          var Gist = (function(_Requestable) {
            ...
            function Gist(id, auth, apiBase) {
              ...
              var _this = _possibleConstructorReturn(
                this,
                (Gist.__proto__ || Object.getPrototypeOf(Gist)).call(
                  this,
                  auth,
                  apiBase
                )
            ...
            _createClass(Gist, [
              ...
              },
              {
                ...
                value: function create(gist, cb) {
                  ...
                  return this._request('POST', '/gists', gist, cb).then(
                    function(response) {
            ...
            _createClass(GitHub, [
              ...
              },
              {
                ...
                value: function getOrganization(organization) {
                  return new _Organization2.default(
                    organization,
                    this.__auth,
                    this.__apiBase
                  );
        ...
        function(require, module, exports) {
          ...
          var Issue = (function(_Requestable) {
            ...
            function Issue(repository, auth, apiBase) {
              ...
              var _this = _possibleConstructorReturn(
                this,
                (Issue.__proto__ || Object.getPrototypeOf(Issue)).call(
                  this,
                  auth,
                  apiBase
                )
          ...
          var Markdown = (function(_Requestable) {
            ...
            function Markdown(auth, apiBase) {
              ...
              return _possibleConstructorReturn(
                this,
                (Markdown.__proto__ || Object.getPrototypeOf(Markdown)).call(
                  this,
                  auth,
                  apiBase
                )
        ...
        function(require, module, exports) {
          ...
          var Project = (function(_Requestable) {
            ...
            function Project(id, auth, apiBase) {
              ...
              var _this = _possibleConstructorReturn(
                this,
                (Project.__proto__ || Object.getPrototypeOf(Project)).call(
                  this,
                  auth,
                  apiBase,
                  'inertia-preview'
                    ...
                    .then(function(_ref) {
                      ...
                      return Promise.all(
                        data.map(function(column) {
                          return _this2._requestAllPages(
        ...
        function(require, module, exports) {
          ...
          var RateLimit = (function(_Requestable) {
            ...
            function RateLimit(auth, apiBase) {
              ...
              return _possibleConstructorReturn(
                this,
                (RateLimit.__proto__ || Object.getPrototypeOf(RateLimit)).call(
                  this,
                  auth,
                  apiBase
                )
      ...
      8: [
            ...
            var Repository = (function(_Requestable) {
              ...
              function Repository(fullname, auth, apiBase) {
                ...
                var _this = _possibleConstructorReturn(
                  this,
                  (
                    Repository.__proto__ || Object.getPrototypeOf(Repository)
                  ).call(this, auth, apiBase)
                );
              ...
              _createClass(Repository, [
                ...
                },
                {
                  ...
                  value: function createBranch(oldBranch, newBranch, cb) {
                    ...
                    return this.getRef('heads/' + oldBranch).then(function(
                      response
                    ) {
                  ...
                  value: function deleteFile(branch, path, cb) {
                    ...
                    return this.getSha(branch, path).then(function(response) {
                      ...
                      return _this4._request(
                        'DELETE',
                        '/repos/' + _this4.__fullname + '/contents/' + path,
                        deleteCommit,
                        cb
                      );
                    });
        ...
        { './Requestable': 9, buffer: 39, debug: 40, 'js-base64': 44, utf8: 47 }
      ],
      9: [
        function(require, module, exports) {
          'use strict';
          ...
          var ResponseError = (function(_Error) {
            ...
            function ResponseError(message, path, response) {
              ...
              var _this = _possibleConstructorReturn(
                this,
                (
                  ResponseError.__proto__ ||
                  Object.getPrototypeOf(ResponseError)
                ).call(this, message)
              );
            ...
            function Requestable(auth, apiBase, AcceptHeader) {
              ...
              if (auth.token) {
                ...
                this.__authorizationHeader =
                  'Basic ' +
                  _jsBase.Base64.encode(auth.username + ':' + auth.password);
              }
            }
            ...
            _createClass(Requestable, [
                ...
                value: function __getRequestHeaders(raw, AcceptHeader) {
                  var headers = {
                    ...
                    Accept:
                      ...
                      (AcceptHeader || this.__AcceptHeader)
                  };
              ...
              },
              {
                ...
                value: function _getOptionsWithDefaults() {
                  ...
                  if (
                    !(requestOptions.visibility || requestOptions.affiliation)
                  ) {
              ...
              },
              {
                ...
                value: function _request(method, path, data, cb, raw) {
                  ...
                  var requestPromise = (0, _axios2.default)(config).catch(
                ...
                value: function _requestAllPages(path, options, cb, results) {
                  ...
                  return this._request('GET', path, options)
                    .then(function(response) {
                      ...
                      (_results = results).push.apply(
                        _results,
                        _toConsumableArray(thisGroup)
                      );
        ...
        { axios: 13, debug: 40, 'js-base64': 44 }
      ],
      10: [
        function(require, module, exports) {
          'use strict';
        ...
        function(require, module, exports) {
          ...
          var Team = (function(_Requestable) {
            ...
            function Team(teamId, auth, apiBase) {
              ...
              var _this = _possibleConstructorReturn(
                this,
                (Team.__proto__ || Object.getPrototypeOf(Team)).call(
                  this,
                  auth,
                  apiBase
                )
      ...
      14: [
        ...
        },
        {
          ...
          './../helpers/buildURL': 29,
          './../helpers/cookies': 31,
          './../helpers/isURLSameOrigin': 33,
          './../helpers/parseHeaders': 35,
          './../utils': 37,
          _process: 46
        }
      ],
      ...
      26: [
        function(require, module, exports) {
          (function(process) {
            ...
            utils.forEach(
              ['delete', 'get', 'head'],
              function forEachMehtodNoData(method) {
        ...
        },
        {
          './adapters/http': 14,
          './adapters/xhr': 14,
          './helpers/normalizeHeaderName': 34,
          './utils': 37,
          _process: 46
        }
      ],
 ...
 */
        ...
        { 'base64-js': 38, ieee754: 42, isarray: 43 }
      ],
      40: [
        function(require, module, exports) {
          (function(process) {
